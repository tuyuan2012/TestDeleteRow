...
- (instancetype)init
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"deleteCell" style:UIBarButtonItemStylePlain target:self action:@selector(deleteSomeCell)];
    return self;
}

- (void)deleteSomeCell
{
    NSIndexPath *indexpath = [NSIndexPath indexPathForRow:1 inSection:0];//there are three sections
    [_tableView beginUpdates];
    [_tableView deleteRowsAtIndexPaths:[NSArray arrayWithObject:indexpath] withRowAnimation:UITableViewRowAnimationFade];
    [_socialAppDataSource removeObjectAtIndex:1];
